...
function initBeerDose() {
  ...
  beerDose.addEventListener('touchstart', (e) => {
    isDragging = true;
    const touch = e.touches[0];
    offsetX = touch.clientX - beerDose.offsetLeft;
    offsetY = touch.clientY - beerDose.offsetTop;
  });

  document.addEventListener('touchmove', (e) => {
    if (isDragging) {
      const touch = e.touches[0];
      beerDose.style.left = (touch.clientX - offsetX) + 'px';
      beerDose.style.top = (touch.clientY - offsetY) + 'px';
    }
  });
